<span style="color:#87f7ae">Funckija</span> je predpis, ki vsakemu elementu iz množice A priredi natanko ene element iz množice B.
Lahko jo izrazimo: 
...
Lastnosti funckij:
- Definicijsko območje ** f je zraven dja ker se nanaša na funkcijo: $$D_f=\mathbb{A}$$
- Zaloga vrednosti:$$Z_f=\mathbb{B}$$
...
## [[Operacije#Računanje s funkcijami|Računanje s funckijami]]

Izračun funkcijske vrednosti pri danem št. $a$. Zapišemo $f(a)$.

## Inverzna funkcija

... je funkcija, ki preslika vse vrednosti iz zaloge vrednosti nazaj v originalne vrednosti originalne množice. Funkcija ima inverzno funckijo, le ko je injektivna.
$$f: x \rightarrow f(x)$$

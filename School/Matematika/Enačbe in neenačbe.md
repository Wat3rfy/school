...
[[Funkcije#Eksponentna funkcija|Eksponentna funkcija]]

#### Logaritemska enačba
[[Funkcije#Logaritemska funkcija|Logaritmeska funkcija]]
...
[[Kotne funkcije in vektorji#1. Kotne funkcije|Trigonometrija]]

So enačbe v katerih nastopa neznanka kot argument v kateri od trigonometričnih funkcij.

Rešitve so presečišča grafov
$$a = \sin x$$
$$x_{1} = \arcsin a + 2\pi k \;;\; k \in \mathbb{Z}$$
$$x_{2} = \pi - \arcsin a + 2\pi k \;;\; k \in \mathbb{Z}$$
$$ $$
$$a = \cos x$$
$$x_{1} = \arccos a + 2\pi k \;;\; k \in \mathbb{Z} $$
$$x_{1} = -\arccos a + 2\pi k \;;\; k \in \mathbb{Z} $$
$$ $$
$$a = \tan x$$
$$x = \arctan a + \pi k \;;\; k \in \mathbb{Z}$$
$$ $$
$$a = \cot x$$
$$x = \text{arccot\;} a + \pi k \;;\; k \in \mathbb{Z}$$

Pri reševanju enačb jih poskušamo izraziti z eno samo.
